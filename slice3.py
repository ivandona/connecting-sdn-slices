...
class SimpleSwitch(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        #dump packets and avoid to save rows in switch 9 and 10 when the destination is not reachable
        if (dpid == 9 and msg.in_port == 3 and dst != "00:00:00:00:00:09") or (dpid == 10 and msg.in_port == 3 and dst != "00:00:00:00:00:0a"):
            return
